...
if any(isfield(sxtra, {'J0eff', 'Jxx0', 'hyp', 'ordered_mode', ...
    ...
    error('invz:solveOpts', ...
          ['J0eff/Jxx0/hyp and the resolved H_MF handoff are driver-owned; ' ...
           'ordered-mode, field-orientation, and removed Tier-2 options are ' ...
           'not supported by the reduced projected solver.']);
end
end
