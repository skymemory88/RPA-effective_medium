...
%INVZ_POLE_CONTINUITY Actual-path G17 crossing-continuity check (Task 18 Step 1; prereg
% docs/invzp_strict_medium_prereg.md SS5, verbatim algorithm). G = -chi (meV^-1), ferromagnetic
% positive J.
%
