...
% Reduces to paramagnetic invz_sigma at m = 0. Requires lam = [lambda_1; lambda_2; lambda_3]
% (invz_lambdas(...,[1 2 3])). K(:) is on the bosonic n>=0 grid so K(1) is the omega_n = 0 slot.
