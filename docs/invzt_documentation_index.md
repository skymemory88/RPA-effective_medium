...
active work order. The only active implementation program on this branch is the
multilevel Jensen-style \(1/z\) program. The projected-spin worktree and branch
...
| [`../invz_projected/README.html`](../invz_projected/README.html) | Reference-only module documentation for the user-certified projected implementation. Its execution records live on the protected projected branch. |
