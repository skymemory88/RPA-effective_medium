...
1. Work only in the isolated worktree
   `invZ expansion-invzt-multilevel-1z`, branch `invzt-multilevel-1z`.
2. Do not edit the projected-spin worktree or branch. The user regards its
   present state as fully working.
